...
"visit.js";switch(dv_GetParam(c,"dvapi")){case "1":E="dvvisit.js";break;case "5":E="query.js";break;default:E="visit.js"}window._dv_win.$dv.DebugInfo.dvp_API=E;for(var O="ctx cmp ipos sid plc adid crt btreg btadsrv adsrv advid num pid crtname unit chnl uid scusrid tagtype".split(" "),ha=[],l=0;l<O.length;l++){var ia=dv_GetParam(c,O[l])||"";ha.push(O[l]+"="+ia);""!==ia&&(window._dv_win.$dv.DebugInfo["dvp_"+O[l]]=ia)}for(var ja="turl icall dv_callback useragent xff timecheck".split(" "),l=0;l<ja.length;l++){var ya=
...
this.getVersionParamName=function(){return"jsver"};this.getVersion=function(){return"57"}};
