...
var ft1064157 = {
	params:window.ftParams_1064157||"",
	guid:window.ftGUID_1064157||"",
	confID:window.ftConfID_1064157||"",
	ftId:'',
	ftReturn: window.ftReturn_1064157||"",
	exttrack:[],
	extscript:[""],
	utilityURL:"",
	atSiteAlias:"",
	...
	setFileSize:"39.3955078125",
	statBaseURL:"http://stat.flashtalking.com/reportV3/ft.stat?43342351-",
	linkMode:"0",
	linkID:"0",
	mvt:false,
	swf:"http://cdn.flashtalking.com/xre/106/1064157/830780/swf/NELB_300x600_female.swf",
	altimg:"http://servedby.flashtalking.com/imp/4/42512;1064157;204;gif;NewYorkTimes;HalfPage/?",
	viewableImpressionURL: "http://servedby.flashtalking.com/imp/4/42512;1064157;202;pixel;NewYorkTimes;HalfPage/?",
	...
	iDeviceImp:"http://servedby.flashtalking.com/imp/4/42512;1064157;207;guid;NewYorkTimes;HalfPage/?ft_guid=",
	clickTags:["http://servedby.flashtalking.com/click/4/42512;1064157;830780;211;[FT_CONFID]/?g=[FT_GUID]&random=[FT_RANDOM]&ft_width=300&ft_height=600&url=http://info.nesl.edu/request-a-new-england-law-boston-viewbook-0"],
	altimghref:"http://servedby.flashtalking.com/click/4/42512;1064157;830780;210;[FT_CONFID]/?g=[FT_GUID]&random=[FT_RANDOM]&ft_width=300&ft_height=600&url=http://info.nesl.edu/request-a-new-england-law-boston-viewbook-0",
	switchArray:["swf","serveDom", "statBaseURL", "utilityURL", "altimg", "altimghref", "viewableImpressionURL", "cdnSrc", "iDeviceImp"],
	divID:"ftdiv1064157",
	swfID:"ftswf1064157",
	altimgID:"ftalt1064157",
	alttext:"Click here",
	altimgtarget:"_blank",
	altimgborder:"0",
	minflashversion:8,
	...
	scriptLocation: document.getElementById("ftscript_m1064157"),
	flashVarHolder:[
		["adVis", "adVis"],
		["divID","divID"],
		["ftfuncid", "pID"],
	...
	outputDiv:function(flash){
		...
		div += '</div>';
		if(window.ftImp1064157 && window.ftImp1064157.jsAppend) {
	...
	replaceMacros:function(str, cb) {
        ...
        return str + (noCache || hasRandom || cb ? '' : '?' + o.random());
    },
